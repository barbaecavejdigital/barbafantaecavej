...
const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess, showToast, onNavigateToHome }) => {
    ...
    return (
        <div className={`flex flex-col items-center justify-center min-h-screen p-6 bg-[#F2F2F7] transition-all duration-700 cubic-bezier(0.2, 0.8, 0.2, 1) ${isEntering ? 'opacity-0 scale-105 blur-sm' : 'opacity-100 scale-100 blur-0'}`}>
            {loginSuccess ? (
                /* Perfectly Centered Success State */
                <div className="flex items-center justify-center animate-fade-in">
                    <div className="relative flex items-center justify-center">
                        <div className="absolute w-32 h-32 bg-emerald-400 rounded-full opacity-20 animate-ripple"></div>
                        <div className="absolute w-32 h-32 bg-emerald-400 rounded-full opacity-10 animate-ripple" style={{ animationDelay: '0.3s' }}></div>
                        <div className="relative w-40 h-40 bg-gradient-to-tr from-emerald-400 to-teal-500 rounded-full flex items-center justify-center shadow-2xl shadow-emerald-200/50 animate-[scale-in_0.5s_cubic-bezier(0.34,1.56,0.64,1)]">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={3} stroke="currentColor" className="w-20 h-20 text-white drop-shadow-sm">
                ...
                <div className="w-full max-w-[380px] animate-fade-in">
                    ...
                    <Card className="shadow-xl shadow-slate-200/50 overflow-hidden relative transition-all duration-500 ease-in-out">
